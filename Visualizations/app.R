        ...
        tabItems(
            ...
            tabItem(tabName = "covar",
                tags$h5("This ", tags$strong("Socioeconomic Associations"), "page of the dashboard investigates the existence of potential associations
                        between county-level characteristics (i.e. poverty and rurality) and different lung cancer histologic types."),
                fluidRow(tags$img(height = 2, width = 1500, src = 'black_line.png')),
                fluidRow(
                    box(width = 12,
            ...
            tabItem(tabName = "covid",
                ...
                tags$h5("A subject of interest would be to determine whether there is a relationship between how counties 
                        are affected by COVID-19 and how they are affected by lung cancer. In order to investigate the potential associations, 
                        two spatial models were constructed for, respectively, the two lung cancer metrics above. Both models are based 
                        on whichever COVID-19 metric has been selected.  
                        The model descriptions as well as the distributions of the parameter are below. If there's a high
